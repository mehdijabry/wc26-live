...
export const matches: Match[] = [
  ...
  { id: 'M31', stage: 'group', group: 'C', home: 'BRA', away: 'HAI', kickoffUTC: t('2026-06-20T01:00'), stadium: 'mia', status: 'scheduled' },
  { id: 'M32', stage: 'group', group: 'D', home: 'TUR', away: 'PAR', kickoffUTC: t('2026-06-20T04:00'), stadium: 'kan', status: 'scheduled' },
  { id: 'M33', stage: 'group', group: 'E', home: 'GER', away: 'CIV', kickoffUTC: t('2026-06-20T17:00'), stadium: 'phi', status: 'scheduled' },
  { id: 'M34', stage: 'group', group: 'F', home: 'JPN', away: 'TUN', kickoffUTC: t('2026-06-20T20:00'), stadium: 'tor', status: 'scheduled' },
  { id: 'M35', stage: 'group', group: 'F', home: 'NED', away: 'SWE', kickoffUTC: t('2026-06-20T23:00'), stadium: 'nyc', status: 'scheduled' },
  { id: 'M36', stage: 'group', group: 'E', home: 'CUW', away: 'ECU', kickoffUTC: t('2026-06-21T02:00'), stadium: 'mty', status: 'scheduled' },
  { id: 'M37', stage: 'group', group: 'H', home: 'ESP', away: 'KSA', kickoffUTC: t('2026-06-21T16:00'), stadium: 'atl', status: 'scheduled' },
  { id: 'M38', stage: 'group', group: 'G', home: 'BEL', away: 'NZL', kickoffUTC: t('2026-06-21T19:00'), stadium: 'sfo', status: 'scheduled' },
  { id: 'M39', stage: 'group', group: 'G', home: 'IRN', away: 'EGY', kickoffUTC: t('2026-06-21T22:00'), stadium: 'sea', status: 'scheduled' },
  { id: 'M40', stage: 'group', group: 'H', home: 'CPV', away: 'URU', kickoffUTC: t('2026-06-22T01:00'), stadium: 'dal', status: 'scheduled' },
  { id: 'M41', stage: 'group', group: 'I', home: 'FRA', away: 'IRQ', kickoffUTC: t('2026-06-22T19:00'), stadium: 'nyc', status: 'scheduled' },
  { id: 'M42', stage: 'group', group: 'I', home: 'NOR', away: 'SEN', kickoffUTC: t('2026-06-22T22:00'), stadium: 'phi', status: 'scheduled' },
  { id: 'M43', stage: 'group', group: 'J', home: 'AUT', away: 'ALG', kickoffUTC: t('2026-06-23T01:00'), stadium: 'kan', status: 'scheduled' },
  { id: 'M44', stage: 'group', group: 'J', home: 'JOR', away: 'ARG', kickoffUTC: t('2026-06-23T04:00'), stadium: 'mex', status: 'scheduled' },
  { id: 'M45', stage: 'group', group: 'L', home: 'PAN', away: 'CRO', kickoffUTC: t('2026-06-23T17:00'), stadium: 'hou', status: 'scheduled' },
  { id: 'M46', stage: 'group', group: 'L', home: 'ENG', away: 'GHA', kickoffUTC: t('2026-06-23T20:00'), stadium: 'mia', status: 'scheduled' },
  { id: 'M47', stage: 'group', group: 'K', home: 'POR', away: 'UZB', kickoffUTC: t('2026-06-23T23:00'), stadium: 'bos', status: 'scheduled' },
  { id: 'M48', stage: 'group', group: 'K', home: 'COL', away: 'COD', kickoffUTC: t('2026-06-24T02:00'), stadium: 'gdl', status: 'scheduled' },
  { id: 'M49', stage: 'group', group: 'A', home: 'RSA', away: 'KOR', kickoffUTC: t('2026-06-24T18:00'), stadium: 'sfo', status: 'scheduled' },
  { id: 'M50', stage: 'group', group: 'A', home: 'CZE', away: 'MEX', kickoffUTC: t('2026-06-24T18:00'), stadium: 'mex', status: 'scheduled' },
  { id: 'M51', stage: 'group', group: 'B', home: 'BIH', away: 'CAN', kickoffUTC: t('2026-06-24T22:00'), stadium: 'tor', status: 'scheduled' },
  { id: 'M52', stage: 'group', group: 'B', home: 'SUI', away: 'QAT', kickoffUTC: t('2026-06-24T22:00'), stadium: 'van', status: 'scheduled' },
  { id: 'M53', stage: 'group', group: 'C', home: 'SCO', away: 'BRA', kickoffUTC: t('2026-06-25T18:00'), stadium: 'lax', status: 'scheduled' },
  { id: 'M54', stage: 'group', group: 'C', home: 'MAR', away: 'HAI', kickoffUTC: t('2026-06-25T18:00'), stadium: 'mia', status: 'scheduled' },
  { id: 'M55', stage: 'group', group: 'F', home: 'NED', away: 'TUN', kickoffUTC: t('2026-06-25T22:00'), stadium: 'sea', status: 'scheduled' },
  { id: 'M56', stage: 'group', group: 'F', home: 'JPN', away: 'SWE', kickoffUTC: t('2026-06-25T22:00'), stadium: 'phi', status: 'scheduled' },
  { id: 'M57', stage: 'group', group: 'E', home: 'CUW', away: 'GER', kickoffUTC: t('2026-06-26T02:00'), stadium: 'hou', status: 'scheduled' },
  { id: 'M58', stage: 'group', group: 'E', home: 'ECU', away: 'CIV', kickoffUTC: t('2026-06-26T02:00'), stadium: 'atl', status: 'scheduled' },
  { id: 'M59', stage: 'group', group: 'D', home: 'PAR', away: 'AUS', kickoffUTC: t('2026-06-26T02:00'), stadium: 'kan', status: 'scheduled' },
  ...
  { id: 'M63', stage: 'group', group: 'G', home: 'NZL', away: 'BEL', kickoffUTC: t('2026-06-26T23:00'), stadium: 'sfo', status: 'scheduled' },
  { id: 'M64', stage: 'group', group: 'G', home: 'EGY', away: 'IRN', kickoffUTC: t('2026-06-26T23:00'), stadium: 'mty', status: 'scheduled' },
  { id: 'M65', stage: 'group', group: 'H', home: 'CPV', away: 'KSA', kickoffUTC: t('2026-06-27T00:00'), stadium: 'hou', status: 'scheduled' },
  { id: 'M66', stage: 'group', group: 'H', home: 'URU', away: 'ESP', kickoffUTC: t('2026-06-27T00:00'), stadium: 'gdl', status: 'scheduled' },
